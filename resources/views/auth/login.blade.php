...
<head>
    ...
    <title>Login - FutureWave EMS</title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <!-- Demo Credentials Info (Optional - Remove if not needed) -->
            <div class="demo-info">
                <p><i class="fas fa-info-circle me-1"></i> Demo Credentials</p>
                <p class="credentials">Admin: admin@futurewave.com / password</p>
                <p class="credentials">Employee: employee@futurewave.com / password</p>
            </div>
        </div>
    </div>
